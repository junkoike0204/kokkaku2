...
//    cam.setPosition(2000*sin(ofMap(ofGetElapsedTimeMillis(), 0, 10000, 0, 2*PI)), 700, 2000*sin(2*ofMap(ofGetElapsedTimeMillis(), 0, 10000, 0, 2*PI)));
      cam.setPosition(600*sin(ofMap(ofGetElapsedTimeMillis(), 0, 10000, 0, 2*PI)), 700+300*sin(ofMap(ofGetElapsedTimeMillis(), 0, 10000, 0, 2*PI)), 1000*cos(ofMap(ofGetElapsedTimeMillis(), 0, 10000, 0, 2*PI)));
